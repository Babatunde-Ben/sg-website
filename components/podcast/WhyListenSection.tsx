  ...
  return (
    <section className="section-padding-x my-20 md:my-24 lg:my-32">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <FadeInUp className="bg-white/4 px-4 py-14 sm:px-10 sm:py-20 md:px-12 md:py-24 lg:px-16 flex items-center justify-center">
        ...
        <StaggerContainer className="bg-primary-400 px-8 py-16 space-y-10 md:px-10 xl:px-16">
