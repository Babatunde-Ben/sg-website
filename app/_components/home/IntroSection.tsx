        ...
        <StaggerContainer className="max-w-4xl mx-auto text-center">
          ...
          <StaggerItem>
            <p className="text-tertiary-600 mb-12 leading-relaxed md:text-lg lg:text-xl">
              ...
              the way we speak matters just as much as what we say, and I am
              committed to delivering truth with kindness. When I step onto your
              stage, I bring preparation, presence, and purpose — guiding the
              room, keeping your program flowing, and leaving your audience with
              something that stays with them long after they&apos;ve gone home.
            </p>
          </StaggerItem>
          <StaggerItem>
