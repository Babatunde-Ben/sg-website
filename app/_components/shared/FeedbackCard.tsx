  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4">
        <div className="group relative size-12 rounded-full overflow-hidden bg-tertiary-200/20">
          <Image src={image} alt={author} fill className="object-cover transition-transform duration-500 ease-in-out group-hover:scale-110" />
        </div>
